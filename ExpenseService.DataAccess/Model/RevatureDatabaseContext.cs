...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer(@"Server=tcp:2002-training-koch.database.windows.net,1433;Initial Catalog=RevatureDatabase;Persist Security Info=False;User ID=jacob;Password=ExpensePassword1;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30
");
            }
        }
